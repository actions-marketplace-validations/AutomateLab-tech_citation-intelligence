...
// immediately. For Bing rank data, use the signals_bing_gap tool, which calls
...
export async function bingSearch(
  ...
  throw new ToolFetchError({
    ...
    message:
      ...
      "Use the signals_bing_gap tool (BING_WEBMASTER_API_KEY) for Bing Webmaster rank data instead.",
  });
}
