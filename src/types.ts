...
export const ENGINE_INTERPRETATION_NOTE: Record<Exclude<Engine, "auto">, string> = {
  ...
  openai:
    "gpt-4.1 + web_search_preview tool via the Responses API. Real chatgpt.com users get a different model tier + SearchGPT with different ranking and UI-level re-scoring.",
  claude:
    "claude-sonnet-4-6 API with web_search tool (max 5 uses). Real claude.ai users get a different model tier and citation UI.",
  gemini:
